/* -*-  Mode: C++; c-file-style: "gnu"; indent-tabs-mode:nil; -*- */
 ...
 main (int argc, char *argv[])
 {
   ...
   NodeContainer staWifiNodes = NodeContainer(networkNodes.Get (1), networkNodes.Get (2), networkNodes.Get (3));
   ...
   ApplicationContainer serverApp = server.Install (staWifiNodes.Get(2)); //hardcoded last sta node
